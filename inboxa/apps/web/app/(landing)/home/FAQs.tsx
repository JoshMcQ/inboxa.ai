const faqs = [
  {
    question: "Can I still use inboxa ai alongside my current email client?",
    answer:
      "Yes! inboxa ai is intended to be used alongside your existing email client.",
  },
  {
  ...
  {
    question: "Which email providers does inboxa ai support?",
    answer:
