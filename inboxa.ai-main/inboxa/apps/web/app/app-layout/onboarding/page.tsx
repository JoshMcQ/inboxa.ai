...
import { Steps } from "@/app/app-layout/onboarding/Steps";
import { OnboardingBulkUnsubscriber } from "@/app/app-layout/onboarding/OnboardingBulkUnsubscriber";
import { OnboardingColdEmailBlocker } from "@/app/app-layout/onboarding/OnboardingColdEmailBlocker";
import { OnboardingAIEmailAssistant } from "@/app/app-layout/onboarding/OnboardingEmailAssistant";
import { OnboardingFinish } from "@/app/app-layout/onboarding/OnboardingFinish";
  ...
  return (
    <div className="mx-auto mt-8 w-full max-w-5xl">
      ...
      <div className="px-4 xl:px-0">
        <PageHeading>First steps to inboxa ai</PageHeading>
        <TypographyP>
          Get to know inboxa ai and set up your account.
        </TypographyP>
      </div>
      ...
      <div className="my-8">
        <Steps
          ...
          steps={[
            ...
            {
              title: "Continue",
              description: "Get started with inboxa ai",
