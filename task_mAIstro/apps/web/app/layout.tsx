...
const title = "InboxaAI | The AI Email Assistant That Actually Works";
const description =
  "InboxaAI is your AI email assistant that reads, understands, and manages your entire inbox through natural conversation. Transform email from a burden into your competitive advantage.";
