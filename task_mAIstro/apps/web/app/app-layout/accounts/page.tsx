...
import { AddAccount } from "@/app/app-layout/accounts/AddAccount";
              ...
              <CardContent className="flex justify-end gap-2">
                ...
                {!emailAccount.isPrimary && (
                  <ConfirmDialog
                    ...
                    description={`Are you sure you want to delete "${emailAccount.email}"? This will delete all data for it on InboxaAI.`}
                    confirmText="Delete"
                    onConfirm={() => {
