...
import { ColdEmailDialog } from "@/app/app-layout/[emailAccountId]/ce-blocker/ColdEmailDialog";

const COLD_EMAIL_BLOCKER_RULE_ID = "ce-blocker-rule";
      ...
      actions: [
        {
          ...
          label: inboxaAILabels.cold_email.name.split("/")[1],
          createdAt: new Date(),
          updatedAt: new Date(),
