    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: "Join InboxaAI with my referral link",
          text: "Use my referral link to get started with InboxaAI!",
          url: link,
        });
      } catch (error) {
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="mt-4 text-lg text-gray-600">
          Share InboxaAI with friends and get a free month for each friend who
